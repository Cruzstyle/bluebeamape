        ...
        42977: function(t, e, n) {
            ...
            function yt(t) {
                ...
                return n && N(n, r) && (n = n.slice(r.length)), n && n.split("\n").forEach((function(t) {
                    ...
                    n && (!n.func && n.line && (n.func = gt), e.push(n))
                })), {
                    message: _t(t, "message"),
                    name: _t(t, "name"),
                    stack: e
                }
            }
            var bt = "((?:file|https?|blob|chrome-extension|native|eval|webpack|<anonymous>|\\w+\\.|\\/).*?)",
                wt = "(?::(\\d+))",
                St = new RegExp("^\\s*at (.*?) ?\\(".concat(bt).concat(wt, "?").concat(wt, "?\\)?\\s*$"), "i"),
                Ct = new RegExp("\\((\\S*)".concat(wt).concat(wt, "\\)"));
            var Tt = new RegExp("^\\s*at ?".concat(bt).concat(wt, "?").concat(wt, "??\\s*$"), "i");
            var kt = /^\s*at (?:((?:\[object object\])?.+) )?\(?((?:file|ms-appx|https?|webpack|blob):.*?):(\d+)(?::(\d+))?\)?\s*$/i;
            var Et = /^\s*(.*?)(?:\((.*?)\))?(?:^|@)((?:file|https?|blob|chrome|webpack|resource|capacitor|\[native).*?|[^@]*bundle)(?::(\d+))?(?::(\d+))?\s*$/i,
            ...
            function Bt() {
                ...
                return l((function() {
                    var n = yt(e);
                    n.stack = n.stack.slice(2), t = Pt(n)
                })), t
            }
            ...
            function Wt(t, e, n) {
                var r = t.site,
                    ...
                    f = t.proxyUrl && qt(t.proxyUrl);
                return {
                    build: function(t) {
                        var r = ["sdk_version:".concat("4.25.0")].concat(n);
                        t && r.push("retry_count:".concat(t.count), "retry_after:".concat(t.lastFailureStatus));
                        var i = "ddsource=browser" + "&ddtags=".concat(encodeURIComponent(r.join(","))) + "&dd-api-key=".concat(o) + "&dd-evp-origin-version=".concat(encodeURIComponent("4.25.0")) + "&dd-evp-origin=browser" + "&dd-request-id=".concat(y());
                ...
                if (t && t.clientToken)
                    if (void 0 === t.sampleRate || _(t.sampleRate))
                        if (void 0 === t.telemetrySampleRate || _(t.telemetrySampleRate)) {
                            var a;
                            if (void 0 === t.telemetryConfigurationSampleRate || _(t.telemetryConfigurationSampleRate)) return a = t.enableExperimentalFeatures, Array.isArray(a) && (lt || (lt = new Set(a)), a.filter((function(t) {
                                return "string" === typeof t
                            })).forEach((function(t) {
                                k(t, "-") && i.warn("please use snake case for '".concat(t, "'")), lt.add(t)
                            }))), h({
            ...
            function Ve() {
                if (mt("clickmap")) return Ee || (Ee = je(), qe().subscribe((function(t) {
                    Ee = t
                })).unsubscribe), {
                    viewport: Ee
                }
                        ...
                        var S = h || u(),
                            ...
                            T = H({
                                _dd: {
                                    ...
                                    browser_sdk_version: vt() ? "4.25.0" : void 0
                                },
                                application: {
                                    id: t.applicationId
                                },
            ...
            var Nn, Ln, Mn = [function(t, e) {
                    if (function() {
                        ...
                        if ("labels" in t && t.labels && t.labels.length > 0) return Fn(t.labels[0], e)
                    } else if (t.id) {
                    ...
                    if ("BUTTON" === t.nodeName || "LABEL" === t.nodeName || "button" === t.getAttribute("role")) return Fn(t, e)
                }, function(t) {
                    ...
                    if ("options" in t && t.options.length > 0) return Fn(t.options[0], e)
                }],
                Pn = [function(t, e) {
                    return Fn(t, e)
                }];
            ...
            var qn, jn = [An, "data-testid", "data-test", "data-qa", "data-cy", "data-test-id", "data-qa-id", "data-testing", "data-component", "data-element", "data-source-file"],
                Vn = [Wn, function(t) {
            ...
            function $n(t, e) {
                return 1 === t.parentElement.querySelectorAll(function() {
                    if (void 0 === qn) try {
                        document.querySelector(":scope"), qn = !0
                    } catch (Eo) {
                        qn = !1
                    }
                    return qn
            ...
            function fr(t, e, n) {
                var i, o = t.map((function(t) {
                    return function(t) {
                        ...
                        if (t instanceof Error) return Dt(yt(t));
                        return C(t, void 0, 2)
                    }(t)
                })).join(" ");
                if (e === r.error) {
                    ...
                    i = a ? Pt(yt(a)) : void 0, o = "console error: ".concat(o)
                }
                return {
                    api: e,
                    message: o,
                    ...
                    function(t, e, n) {
                        return t.subscribe(12, (function(r) {
                            ...
                            t.notify(10, h({
                                ...
                                var o = n.findView(t.startClocks.relative);
                                o && !O(o.featureFlagEvaluations) && (r.feature_flags = o.featureFlagEvaluations);
                                return {
                                    rawRumEvent: r,
                                    startTime: t.startClocks.relative,
                                    domainContext: {
                            ...
                            addError: function(e, n) {
                                var r = e.error,
                                    ...
                                    a = e.context,
                                    u = Mt({
                                        stackTrace: r instanceof Error ? yt(r) : void 0,
                                        originalError: r,
                                        handlingStack: i,
                                        startClocks: o,
            ...
            function Ar(t, e, n, r, i, o, a) {
                ...
                return o && (u = function(t) {
                    ...
                    addFeatureFlagEvaluation: function(t, e) {
                        l.addFeatureFlagEvaluation(t, e), l.scheduleUpdate()
                    },
            ...
            function Ir(t, e, n, r, o, a, u) {
                ...
                return I(), {
                    ...
                    updateTimings: function(t) {
                        v = t, void 0 !== t.loadEvent && _(t.loadEvent)
                    },
                    addTiming: function(t, e) {
                        var n = function(t) {
                            return t < 31536e6
                    ...
                    return t.notify(10, function(t, e, n) {
                        var r = n.getReplayStats(t.id),
                            i = {
                                ...
                                feature_flags: O(t.featureFlagEvaluations) ? void 0 : t.featureFlagEvaluations,
                                session: {
                                    has_replay: !!r || void 0
                                }
                            };
            ...
            function Fr(t, e) {
                ...
                if (void 0 === e && (e = 0), Mr || (Mr = t), t === Mr)
                    if (e >= 100) Vr();
                        ...
                        var o = t.process(i);
                        if (qr() && (i = Gr()).lock !== r) jr(t, e);
                        else {
                            if (o && Hr(o, t.options), qr() && (!o || !Wr(o))) {
            ...
            function Lo(t) {
                var e, n, r, i, o, a, u, s, c = (e = t.mutationController, n = t.mutationCb, r = t.configuration, To(e, n, r).stop),
                    ...
                    v = function(t) {
                        return qe().subscribe(t).unsubscribe
                    }(t.viewportResizeCb),
                    g = function(t, e) {
                        var n = new WeakMap;
            ...
            var Mo = ((Eo = {}).mouseup = Ni, Eo.mousedown = Li, Eo.click = Mi, Eo.contextmenu = Pi, Eo.dblclick = Di, Eo.focus = Bi, Eo.blur = Ui, Eo.touchstart = Fi, Eo.touchend = qi, Eo);
            ...
            var Ho = 0,
                zo = function() {
                    ...
                    return t.prototype.addRecord = function(t) {
                        var e;
                        this.metadata.start = Math.min(this.metadata.start, t.timestamp), this.metadata.end = Math.max(this.metadata.end, t.timestamp), this.metadata.records_count += 1, qo(this.metadata.view.id), (e = this.metadata).has_full_snapshot || (e.has_full_snapshot = t.type === li), this.worker.postMessage({
                    ...
                    function s(t, o) {
                        ...
                        if (a) {
                            var s = new zo(r, a, t, o, (function(t) {
                                ...
                                mt("retry_replay") && "visibility_hidden" !== s.flushReason && "before_unload" !== s.flushReason ? n.send(r) : n.sendOnExit(r)
                            }));
                            i = {
                                status: 1,
                                segment: s,
            ...
            var Jo = function(t, e) {
                    if (void 0 === e && (e = Ko), vt() || "function" !== typeof Array.from || "function" !== typeof CSSSupportsRule) return {
                        start: S,
                        stop: S,
                ...
                Zo = function(t, e, n) {
                    ...
                    function T(n, r, i) {
                        ...
                        b = o.startView, w = o.addAction, S = o.addError, g = o.addTiming, C = o.addFeatureFlagEvaluation, d = o.getInternalContext, m.drain(), e.onRumStart(o.lifeCycle, r, o.session, o.viewContexts)
                    }
                    var k = f((function(t) {
                            b("object" === typeof t ? t : {
                                name: t
                            ...
                            init: f((function(t) {
                                if (!o || !dt()) {
                                    ...
                                    if (function(t) {
                                        ...
                                        if (e) {
                                            if (mt("feature_flags") && (E.addFeatureFlagEvaluation = f((function(t, e) {
                                                    C(t, e)
                                    ...
                                    return t.subscribe(2, (function(t) {
                                        e.add(function(t) {
                                            return {
                                                ...
                                                id: t.id,
                                                name: t.name,
                                                featureFlagEvaluations: t.featureFlagEvaluations
                                            }
                    ...
                    var C = Nr(o, e, location, l, d, m, r, i),
                        T = C.addTiming,
                        k = C.addFeatureFlagEvaluation,
                        E = C.startView,
                        x = gr(o, m, v).addError;
                    Cn(o, e, c), Ne(o, e);
                    var _ = function(t, e, n, r, i) {
                        return {
                            get: function(o) {
                                var a = n.findView(o),
                                    u = i.findUrl(o),
                    ...
                    return {
                        ...
                        addError: x,
                        addTiming: T,
                        addFeatureFlagEvaluation: k,
                        startView: E,
                        lifeCycle: o,
                        viewContexts: v,
                        session: c,
                        getInternalContext: _.get
                    }
                }), Jo);
            ! function(t, e, n) {
                var r = t[e];
...
//# sourceMappingURL=42977.2fb6aaa2dd69576d.js.map